...
class CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		 ...
		 */
		if ( ! @copy( iconv("UTF-8", "big5",$this->file_temp)  , iconv("UTF-8", "big5",$this->upload_path.$this->file_name)))
		{
			if ( ! @move_uploaded_file(iconv("UTF-8", "big5",$this->file_temp), iconv("UTF-8", "big5",$this->upload_path.$this->file_name) ))
			{
