...
function showBackendPager($pager) {
	...
	if (is_array($pager) && ($pager['total_rows'] > $pager['per_page_rows'])) {
		$btn_previous = '<a href="javascript:void()"><i class="fa fa-step-backward" aria-hidden="true"></i></a>';
		$btn_next = '<a href="javascript:void()"><i class="fa fa-step-forward" aria-hidden="true"></i></a>';

		$btn_per_pages = '';
		if ($pager['has_previous']) {
			$btn_previous = '<a href="' . bUrl($pager["action"], TRUE, array("page"), array("page" => ($pager['page'] - 1))) . '"><i class="fa fa-step-backward" aria-hidden="true"></i></a>';
		}

		if ($pager['has_next']) {
			$btn_next = '<a href="' . bUrl($pager["action"], TRUE, array("page"), array("page" => ($pager['page'] + 1))) . '" ><i class="fa fa-step-forward" aria-hidden="true"></i></a>';
		}
		...
		$pager_html =
		'
	        <div class="pagination-info"> ' . $pager["total_count"] . '，Page ' . $pager["page"] . ' of ' . $pager["page_num"] . '</div>

            <div class="pagination">
            	<a href="' . bUrl($pager["action"], TRUE, array("page"), array("page" => 1)) . '" ' . ($pager['page'] == 1 ? 'class="disabled"' : '') . '  ><i class="fa fa-backward" aria-hidden="true"></i></a>' . $btn_previous . $btn_per_pages . $btn_next . '<a href="' . bUrl($pager["action"], TRUE, array("page"), array("page" => $pager["page_num"])) . '"  ' . ($pager['page'] == $pager["page_num"] ? 'class="disabled"' : '') . '  ><i class="fa fa-forward" aria-hidden="true"></i></a>
            </div>
			';
